  ...
  async cancelStaleUnpaidBookings() {
    ...
    for (const booking of bookings) {
      ...
      if (booking.guest?.email) {
        await this.notification.sendBookingCancelled(booking.guest.email, booking.id);
      }
      if (booking.villa?.owner?.email) {
        await this.notification.sendBookingCancelled(booking.villa.owner.email, booking.id);
      }
