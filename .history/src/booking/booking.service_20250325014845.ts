  ...
  async cancelStaleUnpaidBookings() {
    ...
    for (const booking of bookings) {
      ...
      if (booking.guest?.email) {
        await this.notification.sendBookingRejected(booking.guest.email, booking.id);
      }
      if (booking.villa?.owner?.email) {
        await this.notification.sendBookingRejected(booking.villa.owner.email, booking.id);
      }
